...
addpath(genpath('/home/zsh/documents/matlab/Toolbox/Dictionary'));
...
[sout3 D] = ksvdsdenoise(params3d);

printf('\nPerforming 2-D Sparse K-SVD denoising of slice %d...', slicenum);
[sout2, A, nz] = ksvdsdenoise(params2d,0);

B = kron(params2d.basedict{2},params2d.basedict{1});
Dic = B*A;

figure;showdict(Dic,[8 8], 10, 10, 'lines');
%% show results %%

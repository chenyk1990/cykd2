...
% along their corresponding eigenvectors.  
    ...
    figure;visualize_3D_cases_of_structure_tensor_in_ellipse_form('gen_st');
...
%     cla;
    figure;visualize_3D_cases_of_structure_tensor_in_ellipse_form('surfel');
...
%     cla;
    figure;visualize_3D_cases_of_structure_tensor_in_ellipse_form('curvel');
...
% 
%     cla;
    figure;visualize_3D_cases_of_structure_tensor_in_ellipse_form('ball');
